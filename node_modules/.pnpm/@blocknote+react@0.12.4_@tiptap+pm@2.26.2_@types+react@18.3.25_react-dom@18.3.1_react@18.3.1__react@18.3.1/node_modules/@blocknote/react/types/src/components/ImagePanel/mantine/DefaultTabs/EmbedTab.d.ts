...
export declare const EmbedTab: <I extends InlineContentSchema = import("@blocknote/core").InlineContentSchemaFromSpecs<{
    text: {
        config: "text";
        implementation: any;
    };
...
}>>(props: ImagePanelProps<I, S>) => import("react/jsx-runtime").JSX.Element;
