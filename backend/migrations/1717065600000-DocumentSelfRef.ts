...
export class DocumentSelfRef1717065600000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE document MODIFY parent_document_id INT NULL DEFAULT NULL`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Drop FK
    await queryRunner.query(`ALTER TABLE document DROP FOREIGN KEY FK_document_parent`);
    // Revert to NOT NULL with default -1 (legacy)
    await queryRunner.query(`ALTER TABLE document MODIFY parent_document_id INT NULL DEFAULT -1`);
  }
}
